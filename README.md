...
- [Semaphore UI](https://semaphoreui.com) - Modern UI for Ansible, Terraform, OpenTofu, PowerShell and other popular DevOps-tools. ([Source Code](https://github.com/semaphoreui/semaphore)) `MIT` `Docker`
